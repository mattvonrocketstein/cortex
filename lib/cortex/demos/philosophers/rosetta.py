""" cortex.demos.philosophers.rosetta

    Rosetta code solution for dining philosphers.

    This is a reference implementation for the solution at
    cortex.demos.philsophers.code is adapted from.

    Taken from: http://rosettacode.org/wiki/Dining_philosophers#Python
